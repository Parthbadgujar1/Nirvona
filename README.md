...
Needs a local PostgreSQL and a Redis-protocol-compatible server running (Redis on Linux/macOS, [Memurai](https://www.memurai.com/get-memurai) on Windows) — see `backend/SETUP.md` for details.
...
- [ ] Database migrations run (`php migrate.php`)
